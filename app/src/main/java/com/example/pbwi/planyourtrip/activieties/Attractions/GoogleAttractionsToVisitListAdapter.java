...
public class GoogleAttractionsToVisitListAdapter extends ArrayAdapter<GoogleAttractionEntry> {


    public GoogleAttractionsToVisitListAdapter(@NonNull Context context, int resource, @NonNull List<GoogleAttractionEntry> objects) {
